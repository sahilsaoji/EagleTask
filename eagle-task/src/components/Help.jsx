...
const Help = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen bg-[#7B313C] px-4 sm:px-6 lg:px-8 py-10">
            <div className="bg-[#1E1E1E] rounded-[30px] shadow-2xl p-6 sm:p-10 w-full max-w-2xl text-[#D9D9D9]">
                    ...
                    {steps.map((title, index) => (
                        <div key={index} className="border border-[#BC9B6A] rounded-lg">
                            <button
                                ...
                                className={`w-full p-3 sm:p-4 bg-[#BC9B6A] text-white rounded-lg flex justify-between items-center transition duration-200 ${
                            ...
                            {openIndex === index && (
                                <div className="p-3 sm:p-4 bg-[#FFF3D1] text-[#333] rounded-b-lg text-sm sm:text-base">
                                    {index === 0 && (
                                        <>
                                    ...
                                    {index === 4 && (
                                        <>
                                            ...
                                            <div className="bg-[#333] p-3 sm:p-4 rounded-lg mt-2 text-white text-xs sm:text-sm">
                                                <p>Example Token: <code>12345~abcdEfghIjklMnopQrStuvwxYz</code></p>
                                            </div>
                                        </>
                                    )}
                                    {index === 5 && (
                                        <>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 py-2 sm:px-4 sm:py-3 rounded-lg border border-[#BC9B6A] focus:outline-none bg-[#333] text-white placeholder-gray-400 mt-2 text-xs sm:text-sm"
                                                disabled
                ...
                <Link to="/login">
                    <button
                        className="w-full py-2 sm:py-3 mt-6 bg-[#BC9B6A] text-white font-semibold rounded-full hover:bg-[#7B313C] transition duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#7B313C]"
                    >
                        Back to Login
                    </button>
                </Link>
